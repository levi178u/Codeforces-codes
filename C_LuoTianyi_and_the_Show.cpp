               ...
               //Be my CP,I'll be ur Tourist....XD
#include <bits/stdc++.h>
using namespace std; 
...
//___________________________________________COOK HERE_______________________________________________________
    ...
    void ichigo(){
        ...
        fr(i,n){
            ...
            // if(c==n){cout<<1<<endl; return;}

                // if(a[i]==-1 and k<min(n,m)){
                //     k++;

                // }else if(a[i]==-2 and k<min(n,m)){
                //     j--;    
            ...
            int u=ss.sz;
            int e=m-u,s=0;
        ans=min(m,u+max(i1,i2)); lli poo=0;
        for(auto &i:ss){
            
            poo=1+min(i-1,i1+s)+min(m-i+s,i2+u-1);
            ans=max(ans,poo);
            s++;
        } cout<<ans<<endl;
