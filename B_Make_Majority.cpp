...
#define getv(v, n)  vector<lli> v;for (int i = 0; i < n; i++){ take(x) v.push_back(x);}
...
//__________________________________________COOKING DONE______ _________________________________________________
